<x-app-layout>
    ...
    <x-container>
        ...
        <div class="flex justify-between">
            <div>
                <x-link href="{{ route('checklists.create') }}">
            ...
            <div>
                <x-link href="{{ route('checklists.trash') }}">
        ...
        @if ($checklists->count() === 0)
            <x-alert class="bg-yellow-200">
                <p>I'm sorry, {{ Auth::user()->name }}. You don't have any checklists registered yet.<br>
                    But go ahead and <b><a href="{{ route('checklists.create') }}">click here</a></b> to create a new
                    one
                    right now.
                </p>
            </x-alert>
